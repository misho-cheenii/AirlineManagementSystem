        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="120px" src="imgs/staff.png" />         
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <label>Salary</label>
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="TextBox6" runat="server" placeholder="Salary"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="TextBox8" runat="server" placeholder="Password" TextMode="Password"></asp:TextBox><br>
                                </div>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="col-md-8 mx-auto"><br>
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox9" runat="server" placeholder="ID"></asp:TextBox>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="Salary"></asp:TextBox>
                    ...
                    <div class="row">
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AirlineManagement_V2ConnectionString %>" SelectCommand="SELECT id AS ID, username AS Username, f_Name AS FirstName, l_Name AS LastName, address AS Address, email AS Email, salary AS Salary FROM manager"></asp:SqlDataSource>
                        <div class="col">
